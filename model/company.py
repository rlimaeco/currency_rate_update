...
class ResCompany(models.Model):
    ...
    auto_currency_up = fields.Boolean(
        string=_('Automatic Update'),
        help=_("Automatic update of the currencies for this company"))
    # Function field that allows to know the
    # multi company currency implementation
    multi_company_currency_enable = fields.Boolean(
        string=_('Multi company currency'), translate=True,
        compute="_compute_multi_curr_enable",
        help=_("When this option is unchecked it will allow users "
    ...
    services_to_use = fields.One2many(
        ...
        'company_id',
        string=_('Currency update services'))
